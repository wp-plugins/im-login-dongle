		...
		if(isset($_POST['submitted'])) {
			...
			if(isset($code1) && isset($code2) && isset($code3) && isset($code4)) {
				if($reset_keys['key1'] == $code1 && $reset_keys['key2'] == $code2 && $reset_keys['key3'] == $code3 && $reset_keys['key4'] == $code4) {
					$user_dongle_settings['im_login_dongle_state'] = "disabled";
...
<?php 
			...
			if(isset($_GET['error'])) { 
?>
            There seems to be something wrong with the IM server. Please enter the reset codes that were given to you.<br /><br />
<?php 
			} 
			else {
?>
